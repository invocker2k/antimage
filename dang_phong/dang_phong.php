				...
				<div class="wrapper">
					...
					<div class="box-user">
						<div class="box-user_1">
							<a class="appWrapper-Header-navItemLink" href="dang_phong.php">Đăng tin</a>
						</div>
					...
					<div class="main_body">
						...
						<div class="body_left">
							...
							if(isset($_GET['success'])){
								...
								echo "<h3 style='color: red'>Đăng phòng thất bại</h3>";
							}
							?>
							<form class="form_dang_nha" method="post" action="process_dang_phong.php" enctype="multipart/form-data">
								<div class="thong_tin">
									...
									<div class="form_dang_phong">
										<div class="from_group">
											...
											<div class="row_1">
												...
												<input type="number" name="gia" id="gia" class="gia" required>
											</div>
											<!-- hết phần giá -->
											<!-- phần diện tích -->
											<div class="row_2">
												...
												<input type="number" name="dien_tich" id="dien_tich" class="gia" required>
											...
											<div class="row_3">
												...
												<input type="number" name="so_luong_nguoi" id="so_luong_nguoi" class="gia" required>
											</div>
											<!-- Hết số lượng người -->
											<!-- Phần quận huyện -->
											<div class="row_4">
									...
									<div class="form_dang_phong">
										<div class="from_group">
											<div class="row_1">
												...
												<input type="text" name="ten_nguoi_dang" id="ten_nguoi_dang" class="gia" placeholder="Điền đầy đủ họ tên của bạn" required>
											</div>
											<div class="row_2">
												...
												<input type="text" name="sdt_nguoi_dang" id="sdt_nguoi_dang" class="gia" required>
											</div>
											<div class="row_33">
												...
												<input type="text" name="dia_chi_phong" id="dia_chi_phong" class="gia" required>
											</div>
										</div>
									</div>
									<!-- Hết phần đăng phòng -->
									...
									<div class="form_dang_phong">
										<div class="from_group">
											<div class="row_333">
												...
												<input type="text" name="tieu_de" id="tieu_de" class="gia" placeholder="Hãy đặt tiêu đề đầy đủ nghĩa, khách sẽ quan tâm hơn" required>
												...
												<div class="texaria">
													...
													<textarea style="margin: 0px 1px 0px 0px; height: 169px; width: 99%;" id="noi_dung_chi_tiet" name="noi_dung_chi_tiet" placeholder="Nội dung tin ít nhất 10 ký tự. Bạn nên có đủ các thông tin của tin đăng: nhà vệ sinh trong hay ngoài, giá điện, nước, trọ gần khu vực nào và các thông tin thêm của trọ." ></textarea>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="anh_phong">
									...
									<div class="hinh_anh">
										<p style="text-align: center;">Tin đăng có hình ảnh rõ ràng sẽ được xem và gọi gấp nhiều lần so với tin rao không có ảnh. Hãy đăng ảnh để được giao dịch nhanh chóng.</p>
									</div>
								...
								<div class="button">
									<button type="submit" class="btn btn-default" name="button_submit" value="1" onclick="return dang_tin()">Đăng tin</button>
								</div>
							</form>
						</div>
						<!-- Bên phải -->
